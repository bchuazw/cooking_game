...
const en: Dict = {
  ...
  'la.step1.hint': 'Stir circles over the rempah until it blooms',
  'la.step2.title': 'Add in order',
  'la.step2.hint': 'Tap in order: stock, coconut milk, tau pok',
  ...
  'la.step3.hint': 'Hold to blanch, release when the meter is green',
