...
export const CHICKEN_RICE: DishDefinition = {
  ...
  steps: [
    ...
    },
    {
      ...
      shortTitle: 'Rice',
      instruction: 'Drag in the pan until the pull marker reaches the gold band, then release to toss the rice.',
    ...
    },
    {
      ...
      shortTitle: 'Poach',
      instruction: 'Drag the heat handle into the green target band, then drag the spoon through the stock to stir gently.',
    ...
    },
    {
      ...
      shortTitle: 'Sauce',
      instruction: 'Drag sliced chili, ginger, garlic, and lime juice into the mortar, then pull the pestle down and release.',
    ...
    },
    {
      ...
      title: 'Plate the Set',
      shortTitle: 'Plate',
      instruction: 'Drag each item to the highlighted spot so the chicken rice plate is assembled neatly.',
