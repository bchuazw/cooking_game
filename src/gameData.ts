...
export const CHICKEN_RICE: DishDefinition = {
  ...
  steps: [
    ...
    },
    {
      ...
      shortTitle: 'Rice',
      instruction: 'Drag the spoon left and right through the wok so the rice toasts evenly with aromatics.',
    ...
    },
    {
      ...
      shortTitle: 'Poach',
      instruction: 'Drag the heat handle until the thermometer sits in the green zone, then keep it steady for a gentle poach.',
    ...
    },
    {
      ...
      shortTitle: 'Sauce',
      instruction: 'Drag chili, ginger, garlic, and lime juice into the mortar, then hold and grind the pestle up and down.',
