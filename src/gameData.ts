...
export const CHICKEN_RICE: DishDefinition = {
  ...
  steps: [
    ...
    },
    {
      ...
      shortTitle: 'Rice',
      instruction: 'Draw circles in the wok to coat rice with aromatics and chicken fat.',
    ...
    },
    {
      ...
      shortTitle: 'Poach',
      instruction: 'Drag the heat slider into the green simmer zone, then tap bubbles to keep it gentle.',
    ...
    },
    {
      ...
      shortTitle: 'Sauce',
      instruction: 'Tap chili, ginger, garlic, and lime into the mortar, then tap to mash.',
